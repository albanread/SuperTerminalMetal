...
// SuperTerminal v2
//
// Implementation of XRES mode pixel buffer for 320×240 graphics with 256-color palette.
//
...
void XResBuffer::setPixel(int x, int y, uint8_t colorIndex) {
...
uint8_t XResBuffer::getPixel(int x, int y) const {
    std::lock_guard<std::mutex> lock(m_mutex);
...
void XResBuffer::clear(uint8_t colorIndex) {
    std::lock_guard<std::mutex> lock(m_mutex);
...
void XResBuffer::fillRect(int x, int y, int width, int height, uint8_t colorIndex) {
    std::lock_guard<std::mutex> lock(m_mutex);
...
void XResBuffer::hline(int x, int y, int width, uint8_t colorIndex) {
    std::lock_guard<std::mutex> lock(m_mutex);
...
void XResBuffer::vline(int x, int y, int height, uint8_t colorIndex) {
    std::lock_guard<std::mutex> lock(m_mutex);
...
void XResBuffer::blit(int src_x, int src_y, int width, int height, int dst_x, int dst_y) {
    std::lock_guard<std::mutex> lock(m_mutex);
...
void XResBuffer::blitTransparent(int src_x, int src_y, int width, int height, 
                                 int dst_x, int dst_y) {
    std::lock_guard<std::mutex> lock(m_mutex);
...
void XResBuffer::blitFrom(const XResBuffer* src, int src_x, int src_y, int width, int height, 
                         int dst_x, int dst_y) {
    if (!src) {
        return;
    }
...
void XResBuffer::blitFromTransparent(const XResBuffer* src, int src_x, int src_y, int width, int height,
                                     int dst_x, int dst_y) {
    if (!src) {
        return;
    }
