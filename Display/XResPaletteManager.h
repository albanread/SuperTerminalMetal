//
// XResPaletteManager.h
// SuperTerminal v2
//
// Manages hybrid 256-color palette for XRES mode (320×240 graphics).
...
#ifndef SUPERTERMINAL_XRES_PALETTE_MANAGER_H
#define SUPERTERMINAL_XRES_PALETTE_MANAGER_H
...
/// Preset palette types for XRES
enum class XResPalettePreset {
...
/// XResPaletteManager: Manages hybrid palette for XRES mode (320×240)
///
/// Responsibilities:
...
public:
    ...
    /// Create a new XResPaletteManager
    ...
    XResPaletteManager(const XResPaletteManager&) = delete;
    XResPaletteManager& operator=(const XResPaletteManager&) = delete;
    XResPaletteManager(XResPaletteManager&&) = delete;
    XResPaletteManager& operator=(XResPaletteManager&&) = delete;
    ...
    void loadPresetPalette(XResPalettePreset preset);
    ...
    void loadPresetPaletteRows(XResPalettePreset preset, int startRow, int endRow);
...
#endif // SUPERTERMINAL_XRES_PALETTE_MANAGER_H